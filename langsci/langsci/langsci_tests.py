...
class TestFixIndex(unittest.TestCase):
    ...
    def test_fixindex(self):
        ...
        result = indextools.processline(
            r"\indexentry {\v{C}{\'{e}}pl\"o, Slavomír@\v{C}{\'{e}}pl\"o, Slavomír|hyperpage}{2}"
        )
        self.assertEqual(
            result,
            r"\indexentry {Ceplo, Slavomir@\v{C}{\'{e}}pl\"o, Slavomír|hyperpage}{2}",
        )
...
class TestASCII(unittest.TestCase):
    ...
    def test_dediacriticize(self):
        ...
        result = delatex.dediacriticize(
            r"""\'{a}\`{a}\^{a}\~{a}\"{a}\={a}\.{a}\d{a}\v{a}\H{a}\u{a}\k{a}"""
        )
...
class TestBibConversion(unittest.TestCase):
    ...
    def test_record(self):
        bibtests = (
            ...
            (
                "Smith, John (2000c). All on verbs. Bern: Blunder Press.",
                """@book{Smith2000c,\n\taddress = {Bern},\n\tauthor = {Smith, John},\n\tpublisher = {Blunder Press},\n\ttitle = {All on verbs},\n\tyear = {2000}\n}\n""",
            ),
            (
                "Van de Velde, Mark. 2005. The order of noun and demonstrative in Bantu. In Bostoen, Koen & Jacky Maniacky (eds). Studies in African Comparative Linguistics with Special Focus on Bantu and Mande, pp. 425-441. Tervuren: Royal Museum for Central Africa.",
